 ...
 * jQuery AJAX callbacks will set 'this' to the HTTP request created by the AJAX call
 */

/*
 * using underscore bind() function to bind 'this' to function: _.bind(func, obj)
 */
const simpleBook = {};
...
/*
 * bindAll() allows you to use your class's methods with setTimeout or as call-back to jQuery event handlers or AJAX operations , without losing 'this'.
 * bindAll should not be overused because it creates a new copy of every method it binds.
 */
...
/*
 * Underscore's invoke method calls the specified method name on each element of the array passed as first arguement
